...
def plot_summaries(history, plot_name1, plot_name2):
    ...
    ax.plot(df[['total_recall', 'root_recall', 'vowel_recall_1', 'consonant_recall_2', 'val_total_recall', 'val_root_recall', 'val_vowel_recall_1',
                'val_consonant_recall_2']])
    ax.set_ylim(0.5, 1)
    ax.set_title('Recall')
    ax.legend(['total_recall', 'train_root_recall', 'train_vowel_recall', 'train_conso_recall', 'val_total_recall', 'val_root_recall', 'val_vowel_recall',
               'val_conso_recall'],
              loc='lower right')
    ax.grid()
